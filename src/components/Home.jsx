...
function Home() {
  ...
  return (
      <section data-testid='home-1' className='h-screen bg-radial-gradient dark:bg-gradient-to-r dark:from-black dark:via-gray-950 dark:to-gray-900 dark:text-white text-black w-full sm:flex justify-center m-auto'>
      <div className='flex flex-1 flex-col justify-center pl-5 sm:pl-10 md:pl-16'>
        ...
        <motion.a href={resume} initial='hidden' aria-label='resume' whileInView='visible' variants={textVariants} transition={{duration:0.5,delay:2}} className='my-2 dark:bg-green-600 bg-pink-600 dark:hover:bg-green-700 hover:bg-pink-700 text-white rounded-md w-fit px-3 py-1 text-base sm:text-lg md:text-xl'>Checkout CV</motion.a>
      </div>
