...
function Home() {
  ...
  return (
      <section className='h-screen bg-radial-gradient dark:bg-gradient-to-r dark:from-black dark:via-gray-950 dark:to-gray-900 dark:text-white text-black w-full sm:flex justify-center m-auto'>
