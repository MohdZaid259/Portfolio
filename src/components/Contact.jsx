...
function Contact() {
  ...
  return (
      ...
      <div className='flex flex-col gap-1 md:gap-3 mt-10'>
        ...
        <motion.a initial='hidden' whileInView='visible' variants={variants} transition={{duration:0.4}} className='ml-5 mt-1 flex bg-green-600 hover:bg-green-700 max-w-fit items-center gap-3 px-2 rounded' href="https://wa.me/919795372555/" target='_blank'><img loading='lazy' aria-label='whatsapp' className='dark:invert w-5 lg:w-6 h-auto my-2 ' src={whatsapp} alt="" />Chat on Whatsapp</motion.a>
