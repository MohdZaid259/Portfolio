...
function Contact() {
  ...
  return (
      ...
      <h1 className='dark:drop-shadow-[0_0_5px_rgba(0,0,225,1)] -ml-4 md:px-10 text-2xl md:text-3xl  lg:text-5xl mb-7 font-bold text-pink-600 dark:text-green-400'># Contact Me</h1>
