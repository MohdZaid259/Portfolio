...
function Contact() {
  ...
  return (
      <div className='bg-gradient-to-br from-blue-400 via-blue-200 to-red-200 dark:bg-gradient-to-r dark:from-black dark:via-gray-950 dark:to-gray-900 dark:text-white text-black w-full h-full flex justify-around items-center'>
      <div className='flex flex-col gap-3 mt-10'>
        <h2 className='text-3xl font-bold '>Let's <span className='text-pink-600 dark:text-green-500'>Chat</span>.</h2>
      ...
      <div className="flex flex-col border-2 border-black dark:border-white -mt-5 w-2/6 h-2/3 dark:bg-gray-900 bg-gradient-to-br from-blue-400 via-blue-200 to-red-200 from rounded-lg p-4">
        <h2 className='text-3xl mb-3'>Send us a message</h2>
        <form onSubmit={handleSubmit} className='flex flex-col gap-2' action="">
            <input className='dark:bg-gray-950 p-1 px-2 text-lg rounded-md' type="text" placeholder="Full name*"/>
            <input className='dark:bg-gray-950 p-1 px-2 text-lg rounded-md' type="text" placeholder="Email address*"/>
            <input className='dark:bg-gray-950 p-1 px-2 text-lg rounded-md' type="text" placeholder="Subject"/>
            <textarea className='dark:bg-gray-950 p-1 px-2 text-lg rounded-md' name="" id="" cols="20" rows="5" placeholder="Message"/>
            <button type='submit' className='bg-pink-600 dark:bg-green-600 hover:bg-pink-700 dark:hover:bg-green-700 text-white mt-2 p-2 rounded-lg text-xl'>Send Message</button>
        </form>
      </div>
  </div>
  )
