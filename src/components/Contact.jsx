...
function Contact() {
  ...
  return (
      <div className='bg-gradient-to-br from-green-200 via-green-50 to-green-200 dark:bg-gradient-to-r dark:from-black dark:via-gray-950 dark:to-gray-900 dark:text-white text-black w-full h-full md:flex justify-around items-center px-10'>
