...
import vercel from '../Media/skills/vercel.jpeg' 
...
import jest from '../Media/skills/jest.jpeg'
    ...
    <section className="h-full lg:h-screen px-5 py-10 gap-5 bg-radial-gradient dark:bg-gradient-to-r dark:from-black dark:via-gray-950 dark:to-gray-900 dark:text-white text-black">
      ...
      <div className="flex flex-col md:flex-row ">
        <motion.div
          ...
          variants={variants}
          id="shapeContainer"
          className="p-5 mb-5 md:mb-0 -mt-5 grid grid-cols-7 grid-rows-4 md:grid-cols-9 md:grid-rows-5 justify-items-center items-center w-full md:w-3/5"
        >
        ...
        <div className='flex flex-1 justify-center items-center'>
          <div className="grid grid-cols-[auto_auto]  grid-rows-[auto_auto_auto] gap-x-20 gap-y-5">
            <div>
