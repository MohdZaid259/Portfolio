...
function Skills() {
  ...
  return (
    <section className='h-screen px-5 py-10 gap-5 bg-radial-gradient dark:bg-gradient-to-r dark:from-black dark:via-gray-950 dark:to-gray-900 dark:text-white text-black'>
                  ...
                  return (
                      <motion.div variants={variants} key={cellIndex}>
                          {isImageCell && img[cellIndex / 2] && (
                              <img loading='lazy' src={img[cellIndex / 2]} alt="" className="p-1 md:p-2 border border-pink-700 aspect-square object-cover dark:border-green-400 rounded-full w-11 sm:w-14 md:w-16" />
                          )}
                      </motion.div>
                  );
              })}
