...
export default function Header() {
  ...
  return (
      <section className="fixed top-0 w-full z-10 flex justify-evenly items-center py-2 backdrop-blur-sm tracking-normal md:tracking-wider">
          <a href='/'>
          ...
          <div className="flex">
            ...
            <ul
              ...
              className={`dark:bg-inherit dark:text-white sm:text-base w-auto rounded-lg sm:rounded-none p-5 sm:p-0 absolute sm:static top-16 right-2 ${
                ham
                  ? "opacity-100 translate-y-0 -translate-x-14 backdrop-blur-sm"
